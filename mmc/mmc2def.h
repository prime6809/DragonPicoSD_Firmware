...
// Spare MPC23017 I/O reg commands
#define CMD_WRITE_IOREG			0x38
#define CMD_READ_IOREG			0x39
...
#define CMD_GET_RAM_CTRL		0xE8
#define CMD_SET_RAM_CTRL		0xE9

#define CMD_GET_SAMREGS			0xEF
...
// Config bit flags (system), ENABLE_BOOTLOAD no longer used.
...
#define CONFIG_DEFAULT		(CFG_DEBUG_LOG | CFG_BACKUP_FILE)
