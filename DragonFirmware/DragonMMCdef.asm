...
DP_D_STATUS_REG		EQU	    $53			        		; Status register.
D_STATUS_REG		EQU	    IO_BASE+DP_D_STATUS_REG		; Status register.

;STATUS_FLAG_BUSY	EQU	    $01			            ; AVR Busy (old)
STATUS_FLAG_BUSY	EQU	    $80			            ; Pico Busy (bmi...)
...
;
; Shortly to be retired in favor of a command.
DP_D_RAM_CTRL		EQU	    $54			        	; RAM control reg 

D_RAM_CTRL		    EQU	    IO_BASE+DP_D_RAM_CTRL   ; RAM control reg

; D_RAM_CTRL bit encodings
; Not all of these are used in Pico implementation.

D_RAM_ENABLE		EQU 	$01			            ; set to enable overlay ram, clear to disable
D_RAM_VEC		    EQU	    $02			            ; Read interrupt vectors from ROM (0) or RAM (1)
D_FIRQ_ENABLE		EQU	    $04			            ; Enable routing of clock to FIRQ for cart auto-start
D_ROM_A14           EQU     $08                     ; A14 line to the rom, used to select Dragon (0) or CoCo (1)

D_RAM_WP		    EQU	    $10			            ; set to write protect ram, clear to write enable
D_RAM_VEC_WP	    EQU	    $20			            ; Write protect area of RAM containing int vectors.
...
;
; These are now handled by command CMD_GET_SAMBITS.
