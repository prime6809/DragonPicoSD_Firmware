...
typedef struct
{
	uint8_t	Tracks;				// Number of tracks on disk
	uint8_t	SecPerTrack;		// Number of sectors per track Heads = this / DDOS_SECTORS_SS
	uint8_t	NotTracks;			// Tracks ^ 0xFF
	uint8_t	NotSecPerTrack;		// SecPerTrack ^ 0xFF
} DISK_GEOM;
